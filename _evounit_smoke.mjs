...
ok(/function isUnitLikeType\(t\) \{/.test(SRC), 'ONE predicate answers "does this card type have a unit\'s body"');
{
  ...
  ok(/return k === 'unit' \|\| k === 'hero' \|\| k === 'summon' \|\| k === 'evo';/.test(f),
    'and an Evo unit is one of them — alongside units, heroes and summons');
...
ok(/t === 'unit' \|\| t === 'summon' \|\| t === 'evo' \|\| t === 'enchantment' \|\| t === 'curse'/.test(SRC),
  'v121v140 still stands: an Evo unit may be summoned onto a tile');
