/* 🧾 THE FORGE SAVE PATH KEEPS WHAT IT WAS GIVEN (v121v76).
   ...
   — and 134 of those reads end in a LITERAL fallback. A literal fallback is
   ...
   ⚠ THE NUMBER 134 IN THE PARAGRAPH ABOVE IS ASSERTED, NOT WRITTEN DOWN.
   ...
   derived, never transcribed:
     ...
     HALF A — every string-literal id and every CSS selector the save path reads
       ...
       for 356 of the 436 ids; the other 80 arrive through helpers the save path
